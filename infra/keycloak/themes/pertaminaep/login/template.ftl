...
<div class="vg-split">
  ...
  <div class="vg-hero">
    <div class="vg-hero-inner">
      <div class="vg-hero-logo">
        <img class="vg-logo" src="${url.resourcesPath}/img/pertamina-ep-logo.jpg" alt="Pertamina EP" />
      </div>
      <h1 class="vg-hero-title">Selamat Datang Kembali</h1>
      <p class="vg-hero-sub">Masuk untuk memantau seluruh area operasi Anda secara real-time.</p>
    </div>
  </div>
  ...
  <div class="vg-panel">
    ...
    <div class="vg-panel-footer">
      <span>Smart CCTV AI</span>
      <span>&middot;</span>
      <span>Copyright &copy; ${.now?string("yyyy")} Pertamina EP. All Rights Reserved</span>
    </div>
    </div>
  </div>
